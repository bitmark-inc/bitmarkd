...
// convert a binary link to little endian base64 text for JSON
//
...
// convert a little endian base64 string to a link for conversion from JSON
...
// 2. this is hex code in same order as base64 JSON above
