...
func TestPackBlockOwnerTransfer(t *testing.T) {
	...
	expected := []byte{
		...
		0x7c, 0xdd, 0x01, 0x01, 0x22, 0x6d, 0x69, 0x70,
		...
		0x8e, 0x5e, 0x3f, 0xd7, 0xf7,
	}

	expectedTxId := merkle.Digest{
		0xdc, 0xa4, 0x96, 0x94, 0xb3, 0xc8, 0xa3, 0xb6,
		0x88, 0x0c, 0x86, 0x81, 0x3d, 0xbb, 0x38, 0xf0,
		0x17, 0x09, 0xe4, 0xf4, 0xef, 0x1f, 0x92, 0xc5,
		0xe9, 0x58, 0x6c, 0xcc, 0xd4, 0x30, 0xb9, 0x8d,
	}
