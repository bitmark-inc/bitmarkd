...
type BaseData struct {
	BlockNumber      uint64            `json:"block_number,string"` // unsigned 1..N
	TransactionCount uint64            `json:"transactions"`        // unsigned 1..N
	Currency         string            `json:"currency"`            // utf-8
	PaymentAddress   string            `json:"payment_address"`     // utf-8
	Owner            *account.Address  `json:"owner"`               // base58
...
type AssetData struct {
	...
	Registrant  *account.Address  `json:"registrant"`  // base58
	Signature   account.Signature `json:"signature"`   // hex
}
...
type BitmarkIssue struct {
	...
	Owner      *account.Address  `json:"owner"`     // base58: the "destination" owner
