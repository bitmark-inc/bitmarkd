...
var (
	...
	DataLengthLessThanOne      = e("length of byte recieved is less than 1")
	DifferentChain             = e("different chain")
	NotAP2PCommand             = e("not a p2p  command")
	NoPeerID                   = e("no peer ID")
	ReadTimeout                = e("read timeout")
	StreamReadWriter           = e("no good Stream and ReadWriter")
	DataFieldEmpty             = e("data field is empty ")
	ParametersLessThanExpect   = e("not enough parameters")
	NoAnnounceAddress          = e("no announce address")
	AddInfoNil                 = e("AddrInfo is nil")
	NoAddress                  = e("No address")
	NotP2PCommand              = e("Not a P2PCommand")
)
